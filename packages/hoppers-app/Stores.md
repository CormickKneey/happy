...
## Keywords
claude, code, ai, programming, developer, tools, encrypted, secure, coding, assistant, mobile, sync, offline, notifications, privacy, agent

## App Description / Full Description

Hoppers is the secure mobile companion for Claude Code that lets you continue your AI coding sessions anywhere (not affiliated with Anthropic). Built by developers who needed to check on Claude's progress during coffee breaks, this app brings the full Claude Code experience to your phone with military-grade encryption.

**Important**: This app requires Claude Code to be installed on your computer. Hoppers is a companion app that connects to your existing Claude Code setup.
...
**How It Works:**
1. Install the hoppers CLI on your computer
2. Scan a QR code to securely pair your devices
3. Use 'hoppers' instead of 'claude' to start encrypted sessions
...
Hoppers uses the same encryption as Signal (TweetNaCl) and is completely open source. Your encryption keys never leave your device, and all data is encrypted before transmission.
...
### Privacy Policy
https://hoppers.cc/privacy

### Support / Contact
https://hoppers.cc/support
