# Hoppers Content Creator Brief

## Key Features

Hoppers is an open-source mobile app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- On Hoppers, I can manage Claude Code from my phone without paying $600/year
- On Hoppers, I never miss when Claude gets stuck on a permission prompt
- Hoppers runs on my own computer, not expensive cloud servers
- On Hoppers, I can check on long-running tasks without returning to my desk
- Hoppers is open source - I can audit, modify, or self-host everything
- On Hoppers, I can run multiple agents in parallel and switch between them instantly
- Hoppers keeps my code on my machines with end-to-end encryption
- On Hoppers, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source Hoppers"
...
- Clearly say "Hoppers" in the video or caption
- Mention it's free and open source
- Include link to github.com/CormickKneey/hoppers
