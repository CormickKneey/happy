...
export default function FriendsScreen() {
    ...
    const [acceptLoading, doAccept] = useHoppersAction(async () => {
    ...
    const [rejectLoading, doReject] = useHoppersAction(async () => {
        if (!credentials || !processingId) return;
    ...
    const [removeLoading, doRemove] = useHoppersAction(async () => {
        if (!credentials || !processingId) return;
