...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Hoppers è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un Hoppers Server valido',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Esegui npm install -g hoppers@latest',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Hoppers. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `hoppers daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `npm install -g hoppers@latest`',
        daemon: 'Daemon',
        status: 'Stato',
