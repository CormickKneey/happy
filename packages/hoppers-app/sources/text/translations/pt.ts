...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Hoppers é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g hoppers@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Hoppers CLI',
            runIt: 'Execute',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Hoppers. Isso permitirá que o terminal envie e receba mensagens com segurança.',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `hoppers daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g hoppers@latest`',
