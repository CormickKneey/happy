...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Hoppers — мобильное приложение для работы с Codex и Claude Code. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g hoppers@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите Hoppers CLI',
            runIt: 'Запустите его',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Терминал запрашивает подключение к вашему аккаунту Hoppers. Это позволит терминалу безопасно отправлять и получать сообщения.',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `hoppers daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g hoppers@latest`',
