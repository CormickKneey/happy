...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Hoppers es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g hoppers@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Hoppers CLI',
            runIt: 'Ejecútelo',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Hoppers. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `hoppers daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g hoppers@latest`',
