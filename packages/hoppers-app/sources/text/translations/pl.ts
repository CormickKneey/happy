...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Hoppers to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g hoppers@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj Hoppers CLI',
            runIt: 'Uruchom je',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Hoppers. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `hoppers daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g hoppers@latest`',
