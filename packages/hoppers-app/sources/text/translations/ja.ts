...
export const ja: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'HoppersはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
    ...
    server: {
        ...
        notValidHappyServer: '有効なHoppers Serverではありません',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Hoppers Session IDがクリップボードにコピーされました',
        failedToCopySessionId: 'Hoppers Session IDのコピーに失敗しました',
        ...
        updateCliInstructions: 'npm install -g hoppers@latest を実行してください',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがHoppersアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',
    ...
    machine: {
        ...
        offlineHelp: '• コンピューターがオンラインであることを確認してください\n• `hoppers daemon status`を実行して診断してください\n• 最新のCLIバージョンを使用していますか？`npm install -g hoppers@latest`でアップグレードしてください',
        daemon: 'デーモン',
        status: 'ステータス',
        stopDaemon: 'デーモンを停止',
