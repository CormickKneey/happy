/**
 * English translations for the Hoppers app
 * Values can be:
...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Hoppers is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    newSession: {
        ...
        noMachinesFound: 'No machines found. Start a Hoppers session on your computer first.',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Hoppers Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Hoppers Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Hoppers Session ID',
        happySessionId: 'Hoppers Session ID',
        ...
        updateCliInstructions: 'Please run npm install -g hoppers@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the Hoppers CLI',
            runIt: 'Run it',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Hoppers account. This will allow the terminal to send and receive messages securely.',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `hoppers daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g hoppers@latest`',
        daemon: 'Daemon',
        status: 'Status',
