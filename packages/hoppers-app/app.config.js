...
const name = {
    development: "Hoppers (dev)",
    preview: "Hoppers (preview)",
    production: "Hoppers"
}[variant];
const bundleId = {
...
export default {
    expo: {
        ...
        ios: {
            ...
            infoPlist: {
                ...
                NSAppTransportSecurity: {
                    NSAllowsArbitraryLoads: variant !== 'production',
                    NSAllowsLocalNetworking: true
                }
            },
            associatedDomains: variant === 'production' ? ["applinks:app.hoppers.cc"] : []
        },
        android: {
            adaptiveIcon: {
        ...
        updates: {
            url: "https://u.expo.dev/8a9485e6-fb06-4039-a7ce-c8a15345af62",
            requestHeaders: {
        ...
        extra: {
            ...
            eas: {
                projectId: "8a9485e6-fb06-4039-a7ce-c8a15345af62"
            },
            app: {
