...
`@hoppers-app/hoppers-wire` centralizes definitions for:
...
In this repository, consumer workspaces import `@hoppers-app/hoppers-wire` through package exports that point at `dist/*`.

That means on a clean checkout:
1. Build wire first: `yarn workspace @hoppers-app/hoppers-wire build`
...
yarn workspace @hoppers-app/hoppers-wire build
yarn workspace @hoppers-app/hoppers-wire test
```
