...
This folder documents how Hoppers works internally, with a focus on protocol, backend architecture, deployment, and the CLI tool. Start here.
...
- hoppers-wire.md: Shared wire schemas/types package and migration notes.

## Conventions
- Paths and field names reflect the current implementation in `packages/hoppers-server`.
