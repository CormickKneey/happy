...
- Mapping to Claude happens in `packages/hoppers-cli/src/claude/utils/permissionMode.ts`:
...
`packages/hoppers-app/sources/sync/storage.ts`
...
`packages/hoppers-app/sources/sync/persistence.ts`

If draft permission mode is missing:
- Draft default: `default`

### 3) New session UI defaults
`packages/hoppers-app/sources/app/(app)/new/index.tsx`
`packages/hoppers-app/sources/components/NewSessionWizard.tsx`
...
`packages/hoppers-app/sources/sync/sync.ts`
...
`packages/hoppers-cli/src/claude/runClaude.ts`
`packages/hoppers-cli/src/claude/utils/permissionMode.ts`
...
`packages/hoppers-cli/src/claude/claudeLocal.ts`
